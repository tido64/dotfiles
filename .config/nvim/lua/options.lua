...
-- Disable mouse drag to prevent accidentally selecting text
vim.keymap.set('n', '<LeftDrag>', '', noremap)
vim.keymap.set('n', '<LeftRelease>', '', noremap)
